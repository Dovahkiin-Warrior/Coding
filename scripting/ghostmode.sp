// El Diablo modified to work with Super Smash Bros
...
// ====[ PLUGIN ]==============================================================
public APLRes:AskPluginLoad2SBCustom(Handle:hPlugin, bool:bLateLoad, String:strError[], iErrorSize)
{
...
public OnPluginStart()
{
	...
	g_hCvarTeleporting = CreateConVar("sm_ghostmode_teleporting", "0", "Enable teleporting\n0 = Disabled\n1 = Random target\n2 = Random team target", _, true, 0.0, true, 2.0);
	...
	g_hCvarWearables = CreateConVar("sm_ghostmode_wearables", "1", "Enable wearables on ghosts\n0 = Disabled\n1 = Enabled", _, true, 0.0, true, 1.0);
	...
	RegAdminCmd("sm_ghost", Command_Ghost, 0, "Ghost Mode");
...
public Action:Event_PlayerDeath(Handle:hEvent, String:strName[], bool:bDontBroadcast)
{
	...
	if(SB_GetPlayerProp(iClient,iLives)>0)
	{
		return;
	}
